...
public:
    // constructor
    // Qiestion 4 -----------------------------------------------------------------------
    // Used GBT to make plane contructor
    ...
    void operate(int timestep, int maxIterations, const std::string& pilotName) {
        ...
        while (iteration < maxIterations && pos < distance) {
            std::cout << "Pilot Name: " << pilotName << std::endl; // Prints out pilot name
            std::cout << "Pilot Memory Address: " << &pilotName << std::endl; // Prints out pilot memory address
            std::cout << "Plane Memory Address: " << this << std::endl; // Prints plane memory address
        ...
        // If statement tracks the plane and prints out when the plane reaches destination
        if (pos >= distance) {
...
public:
    Pilot(const std::string& pilotname) : name(pilotname) {
        //output pilots name and gets memory address
    ...
    void switchControl(Plane* newPlane){
       //Use of AI for switchControl function 
